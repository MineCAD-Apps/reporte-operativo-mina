...
Si la actualización anterior ya está publicada, sustituye en GitHub únicamente los archivos que siguen. Esta revisión visual no modifica `Code.gs`, las hojas de Google ni las implementaciones de Apps Script:
